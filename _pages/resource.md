...
## Ready-to-Use Lab Software
1. [mProcess V4.0](/files/app/mProcess%20V4.0.exe): a self-developed tool for microplate data preprocessing
    <div style="text-align: left;"><br>
        <a href="/files/app/pic/mProcess.gif" target="_blank">
            <img src="/files/app/pic/mProcess.gif" alt="zGrating" width="400px">
        </a>
    </div><br>

2. [zGrating V2.3](/files/app/zGrating_V2.3.exe): a self-developed visual stimulus generator
   <div style="text-align: left;"><br>
        <a href="/files/app/pic/zGrating.gif" target="_blank">
            <img src="/files/app/pic/zGrating.gif" alt="zGrating" width="400px">
        </a>
    </div><br>
...
`bundle exec jekyll serve --livereload`<br>
`jekyll clean`
...
<br><br><br><br>
Plasmids, codes, to be continued...
